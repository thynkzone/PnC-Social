...
if (db.verifycsrftoken(token)) {
			...
			x = antisamy.safe(request.getParameter("tixes"));
			y = antisamy.safe(request.getParameter("tixes2"));
			if (x != null && y != null) {
				db.thymanagerad(x, y);
				response.sendRedirect("manage-ads.jsp");
				return;
			}
	...
	return;
				...
				response.sendRedirect("index.jsp");
				System.out.print(ex+"at adapprove.jsp");
				}
	%>
