...
if (db.verifycsrftoken(token)) {
			...
			x = antisamy.safe(request.getParameter("farxes"));
			if (x != null) {
				db.thymanagerrepprodel(x);
				response.sendRedirect("manage-profile-reports.jsp");
				return;
			}
	...
	return;
				...
				System.out.print(ex+"at repproapprove.jsp");
				}
	%>
