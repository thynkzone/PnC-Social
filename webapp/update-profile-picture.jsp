...
<title>P&C - Update Profile Picture</title>
<meta charset="UTF-8">
...
<div class="main-center-container">
  ...
  <div class="page-header">
    <h1 class="page-title"><i class="fa-solid fa-user-circle"></i> Update Profile Picture</h1>
  </div>
  ...
  <div class="upload-form-container">
    <div class="upload-card">
      <form name="uploadForm" action="process2.jsp" method="POST" enctype="multipart/form-data">
      ...
      <div class="preview-section" id="previewSection" style="display: none;">
        <div class="preview-title">Profile Picture Preview</div>
        <img id="previewImage" class="preview-image" alt="Profile picture preview" />
      </div>
    </div>
  </div>
</div>
...
uploadArea.addEventListener('click', (e) => {
  // Only open file picker if the click is directly on the upload area, not its children
...
<%
    ...
    System.out.print(ex+"at update-profile-picture.jsp");
}
%>
</body>
</html>