...
if (db.verifycsrftoken(token)) {
			...
			String x = null;
			String y = null;
			x = antisamy.safe(request.getParameter("axes"));
			y = antisamy.safe(request.getParameter("axes2"));
			if (x != null && y != null) {
				//dummydum or like process is the only where y = posterid
				db.thylike(ix, x, y);
			}
	...
	return;
				...
				response.sendRedirect("index.jsp");
				System.out.print(ex+"at dummydum.jsp");
		}
	%>
