...
<title>Co-workers & Followers - P&C (People & Culture)</title>
<meta charset="UTF-8">
...
.stat-card.following .stat-count {
  color: var(--accent-primary);
}
.stat-card.followers .stat-count {
...
/* Fix stat icons and section icons visibility */
.stat-icon, .section-icon {
  filter: brightness(0) invert(1);
  transition: var(--transition);
}
...
<div id="content" class="content">
  ...
  <nav class="tab-navigation">
    <ul class="tab-nav-list">
      ...
      <li class="tab-nav-item">
        <a href="following.jsp" class="tab-nav-link active">
  ...
  <div class="stats-header">
    <div class="stat-card following">
      <img src="icon/idol.png" alt="" class="stat-icon"/>
      <div class="stat-title">You're Following</div>
      <div class="stat-count"><%=db.countfol(ix, 0)%></div>
    </div>
    <div class="stat-card followers">
      <img src="icon/people.png" alt="" class="stat-icon"/>
      <div class="stat-title">Your Followers</div>
      <div class="stat-count"><%=db.countfol(ix, 1)%></div>
    </div>
  </div>
  ...
  <div class="people-grid">
    ...
    <div class="people-section">
      <h2 class="section-title">
        <img src="icon/idol.png" alt="" class="section-icon"/>
        People You Follow
      </h2>
	...
	while (rs4.next()) {
      ...
      %>
        <a href="profile.jsp?userId=<%=fid3%>" class="person-card">
          <img class="person-avatar" src="<%=imdir2%>" alt="<%=yourfullname2%>">
          <div class="person-info">
            <div class="person-name"><%=yourfullname2%></div>
            <div class="person-meta">
              <%if(iscounting > 0){out.print(iscounting+" Mutual Co-worker");}if(iscounting > 1){out.print("s");}%>
            </div>
          </div>
        </a>
      <%
      ...
      %>
        <div class="empty-state">
          ...
          <a href="people-you-may-know.jsp" style="color: var(--accent-primary);">Discover people to follow</a>
        </div>
      <%
      }
	%>
    ...
    <div class="people-section">
      <h2 class="section-title">
        <img src="icon/people.png" alt="" class="section-icon"/>
        Your Followers
      </h2>
      ...
      boolean hasFollowers = false;
		...
		String qry2 = "select * from `".concat(ix).concat("` WHERE yorn = 1");
      ...
      %>
        <a href="profile.jsp?userId=<%=fid2%>" class="person-card">
          <img class="person-avatar" src="<%=imdir1%>" alt="<%=yourfullname1%>">
          <div class="person-info">
            <div class="person-name"><%=yourfullname1%></div>
            <div class="person-meta">
              <%if(iscounting > 0){out.print(iscounting+" Mutual Co-worker");}if(iscounting > 1){out.print("s");}%>
            </div>
          </div>
      ...
      <%
			...
			<%
				...
				System.out.print(ex+"at following.jsp");
			}
%>
