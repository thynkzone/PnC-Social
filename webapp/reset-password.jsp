...
#message {
  ...
  margin-top: 10px;
  width: 100%;
font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;  font-size: 1rem;
  background: var(--bg-glass);
  border-radius: 10px;
  padding: 1rem 1.2rem;
  text-align: left;
...
<div class="main-center-container">
  <form class="verify-card" name="frm" action="newpass.jsp" method="POST">
    <h2><i class="fa-solid fa-key"></i> Reset your password</h2>
    <div style="margin-bottom: 0.7rem; color: var(--text-secondary); text-align: center;">Enter your new password below.</div>
    <input class="input-field" type="password" name="pwd" id="psw" placeholder="New password" minlength="8" maxlength="50" required>
    <input class="input-field" type="password" name="pwd2" placeholder="Re-type new password" minlength="8" maxlength="50" required>
    <input type="hidden" name="csrf" value="<%=db.csrftoken()%>">
    <button class="button" type="submit">Set New Password</button>
    <div id="message">
      <h3 style="color: #fff; font-size: 1.05rem; margin-bottom: 0.5rem;">*Password must contain the following:</h3>
  ...
  <div class="info-box">
    Please choose a strong password. If you have any issues, contact support.<br><br>
