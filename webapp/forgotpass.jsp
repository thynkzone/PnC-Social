...
<div class="main-center-container">
  <form class="verify-card" name="frm" action="loginforgot.jsp" method="POST">
    <h2><i class="fa-solid fa-unlock-keyhole"></i> Forgot your password?</h2>
    <div style="margin-bottom: 0.7rem; color: var(--text-secondary); text-align: center;">Enter your email and account recovery code to reset your password.</div>
    <input class="input-field" type="email" name="email" placeholder="Enter your email address" maxlength="50" required>
    <input class="input-field" type="text" name="phone" placeholder="Account recovery code" minlength="3" required>
    <noscript>
      <input type="hidden" name="jss" value="x">
    </noscript>
    <input type="hidden" name="csrf" value="<%=db.csrftoken()%>">
    <button class="button" type="submit">Submit</button>
  </form>
  <div class="info-box">
    If you forgot your password, enter your email and the recovery code you set up during registration.
    If you can't remember your recovery code, please contact support: thynkzone.help@gmail.com<br><br>
