...
if (db.verifycsrftoken(token)) {
			...
			String x = null;
			x = antisamy.safe(request.getParameter("vaaxes"));
			if (x != null) {
				db.thyprorepdel(ix, x);
				response.sendRedirect("profile.jsp?userId="+x.substring(3));
				return;
			}
	...
	return;
				...
				response.sendRedirect("index.jsp");
				System.out.print(ex+"at secprorepdel.jsp");
				}
	%>
