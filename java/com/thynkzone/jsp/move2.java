...
public class move2 {    
	...
	public static String main(String dir, int key) throws IOException, NoSuchAlgorithmException {
	...
	String pporbp = null;
	    ...
	    String iis = pporbp.concat(imgppcode.ran()).concat("_").concat(uidgen.id()).concat("_").concat(imgppcode.ran());
